...
* **PYTHON**
  ...
  * [Пример веб-приложения на Python + Flask для управления пользователями. Также в проекте реализованы API‑тесты с использованием pytest.](https://github.com/fshakrun/FlaskUsersApp)
